...
(defun get-size-indication-format ()
  (if (and transient-mark-mode mark-active)
      (format "%dL %dC" (count-lines (region-beginning) (region-end)) (abs (- (mark t) (point))))
    "%I"))
...
(setq-default mode-line-buffer-identification (propertized-buffer-identification "%15b"))
