...
(defconst thrift-font-lock-keywords
  (list
   ...
   '("//.*$" . font-lock-comment-face)  ;; c/c++ style comments
   '("\\<\\(include\\|struct\\|exception\\|typedef\\|const\\|enum\\|service\\|extends\\|void\\|oneway\\|throws\\|optional\\|required\\|namespace\\)\\>" . font-lock-keyword-face)  ;; keywords
